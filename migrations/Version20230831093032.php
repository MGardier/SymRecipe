 ...
 */
final class Version20230831093032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE full_name full_name VARCHAR(180) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE full_name full_name VARCHAR(50) NOT NULL');
    }
}
